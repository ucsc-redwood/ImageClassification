...
int main() {
    ...
    int linearWeightSize;
    float* linear_weight_data = readDataFromFile("classifier_weight.txt", linearWeightSize);
    int linearBiasSize;
    float* linear_bias_data = readDataFromFile("classifier_bias.txt", linearBiasSize);
